...
function getSalesDetails(title, category) {
    const salesData = {
        '다분야 전산관리 경험': {
            ...
            achievements: [
                '다양한 산업군 경험: 교육, 부동산, 제조업 등 각기 다른 산업 환경에 최적화된 IT 솔루션 제공',
        ...
        '교육청 전산유지보수': {
            ...
            achievements: [
                '대규모 인프라 관리: 전산장비 및 OA 사무기기 2,000대 규모 완벽 관리, PC, 서버, 네트워크 장비 통합 운영 및 유지보수, 시스템 가동률 99.8% 달성으로 무장애 서비스 실현',
        ...
        '카드발급기 기술영업 전문가': {
            ...
            achievements: [
                ...
                '금융권 카드발급 시스템: 1금융, 2금융 은행권 카드발급기 영업 및 납품으로 금융 보안 표준 충족',
                '호텔/리조트 회원권 시스템: 국내 리조트, 팬션, 호텔 회원권 카드 발급기 납품으로 고객 서비스 향상',
                '교육기관 학생증 시스템: 국내 중,고등학교 학생증 발급 카드 발급기 납품으로 학교 관리 효율화',
                '이벤트/행사 카드 시스템: 이벤트, 행사 업체 카드발급기 납품 및 렌탈 서비스로 행사 운영 최적화'
            ],
